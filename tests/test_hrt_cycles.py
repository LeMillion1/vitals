...
async def test_only_one_open_cycle_after_supersede(db_session, owner_write):
...
async def test_route_create_cycle_over_active_switches(auth_client, db_session, owner_write):
